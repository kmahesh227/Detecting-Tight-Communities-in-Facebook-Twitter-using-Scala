...
val graph = GraphLoader.edgeListFile(sc,"/FileStore/tables/pe9r5ypd1492789638458/facebook_combined_-35683.txt",true) .partitionBy(PartitionStrategy.RandomVertexCut)
...
val Data= sc.textFile("/FileStore/tables/pe9r5ypd1492789638458/facebook_combined_-35683.txt")
